                ...
                {userCart?.map((item,index)=>{
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      <h2 className="text-sm  text-gray-900 line-clamp-2" style={{ color: mode === 'dark' ? 'white' : '' }}>{item?.description}</h2>
                      <p className="mt-1 text-xs font-semibold text-gray-700" style={{ color: mode === 'dark' ? 'white' : '' }}>₹{item?.price}</p>
                    </div>
                    <div  className="mt-4 flex justify-between items-center sm:flex sm:items-end sm:flex-col sm:space-y-6 sm:mt-0 sm:block sm:space-x-6  ">
                      ...
                      <button onClick={()=>{
                        ...
                        console.log(item)
                         ...
                         type="button" className="focus:outline-none w-24 text-white bg-violet-600 md:hidden hover:bg-violet-800  outline-0 font-medium rounded-lg text-sm px-2 py-2.5  ">Order Now</button>
                    </div>
                  </div>
                </div>
                  )
